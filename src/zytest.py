...
parser.add_option("--dist", action="store_true", dest="distance", default=False,help="compute the distance to the tag")
...
td.takeVideo(demo=demo,comparison=comparison, distance=dist)
exit()
